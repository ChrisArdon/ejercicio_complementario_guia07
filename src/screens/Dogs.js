            ...
            <ScrollView style={styles.section}>
                <View style={styles.sectionItem}>
                    ...
                    <View>
                        ...
                        <Text style={styles.dogCountry}>Estados Unidos</Text>
                    </View>
                </View>
                <View style={styles.sectionItem}>
                    <Image 
                    ...
                    <View>
                        ...
                        <Text style={styles.dogCountry}>Escocia</Text>
                    </View>
                </View>
                <View style={styles.sectionItem}>
                    <Image 
                ...
                <View style={styles.sectionItem}>
                    ...
                    <View>
                        ...
                        <Text style={styles.dogCountry}>Irlanda</Text>
                    </View>
                </View>
            </ScrollView>
        </>
